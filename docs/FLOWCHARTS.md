...
```text
writes:  SchedulerPort facade + thin-adapter-bound ports (update/dispatch/reconcile/
         status/dispatch-log/health) — the register/cancel/reschedule use cases sit
         behind SchedulerAdapter only
