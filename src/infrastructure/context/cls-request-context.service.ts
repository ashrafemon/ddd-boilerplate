...
import { CLS_REQUEST_CONTEXT_KEY, RequestContext, RequestContextData } from '../../shared-kernel/ports/context/request-context';
...
export class ClsRequestContextService implements RequestContextPort {
  ...
  public require(): RequestContext {
    ...
    if (!context) {
      throw new Error('Request context is not available. Is the RequestContextInterceptor mounted?');
    }
    return context;
  }
